...
class Menu extends React.Component {
  ...
  exportDiagram = () => {
    ...
    modeler.saveXML({ format: true }, function(err, xml) {
      ...
      //   type: "POST",
      //   url:
      //     "C:/Users/pausldus/Documents/Visual Studio Code/Sem/bpmn_modeler/src/resources/",
      //   data: {
      //     strXml: xml
      //   }
      // }));
  ...
  importDiagram = evt => {
    ...
    viewer.importXML(file, function(err) {
      if (err) {
      ...
      <ul className="menu">
        <li className="dropdown">
          ...
          <div className="dropdown-content">
            <a href="aa" onClick={this.exportDiagram}>
              Save
            </a>
            <a href="bb">
              {/* <input onClick={this.importDiagram} type="file" id="file" name="file" /> */}
              Import
            </a>
          </div>
        </li>
